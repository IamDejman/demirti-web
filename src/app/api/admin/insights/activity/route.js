/**
 * Alias for event-log. Use this path to avoid ad blockers that block /analytics/event-log.
 */
...
export async function GET(request) {
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to load activity', details: process.env.NODE_ENV === 'development' ? error?.message : undefined }, { status: 500 });
  }
}
